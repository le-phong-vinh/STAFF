        ...
        <div class="main-content">
            ...
            <div class="row g-3">
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="card h-100">
                        <div class="card-header fw-bold d-flex justify-content-between align-items-center">
                            ...
                            <form class="d-flex align-items-center gap-2" action="report" method="get">
                                <input type="text" name="serviceName" class="form-control form-control-sm"
                                       placeholder="Tìm theo dịch vụ..." style="width:160px;"
                                       value="<%= request.getParameter("serviceName") != null ? request.getParameter("serviceName") : ""%>">
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="card h-100">
                        <div class="card-header fw-bold d-flex justify-content-between align-items-center">
                            <span>📋 Thống kê bệnh nhân theo loại bệnh</span>

                            <!-- ✅ Bộ lọc theo tên bệnh -->
                            <form class="d-flex align-items-center gap-2" action="report" method="get">
                                <input type="text" name="diseaseName" class="form-control form-control-sm"
                                       placeholder="Tìm theo bệnh..." style="width:160px;"
                                       value="<%= request.getParameter("diseaseName") != null ? request.getParameter("diseaseName") : ""%>">
                                <button type="submit" class="btn btn-sm btn-primary">
                                    <i class="bi bi-search"></i>
                                </button>
                                <a href="report" class="btn btn-sm btn-outline-secondary">
